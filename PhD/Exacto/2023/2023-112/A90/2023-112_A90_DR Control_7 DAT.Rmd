...
ED50.reflex <- ED(model.LL2.3, (summary(model.LL2.3)$coefficients[3, 1] * 0.5), clevel = "reflex", type = "absolute", interval = "fls", logBase = exp(1))

ED50.EXT1490 <- ED(model.LL2.3, (summary(model.LL2.3)$coefficients[6, 1] * 0.5), clevel = "A90|EXT1490", type = "absolute", interval = "delta")
