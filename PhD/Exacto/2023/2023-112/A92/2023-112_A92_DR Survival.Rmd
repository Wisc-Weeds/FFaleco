---
title: "Exacto 2023-112 A92 DR Survival"
...
model.LL4 <- drm((surv * 100) ~ rate, herb, fct = LL.4(),  data = data, type = "continuous")
...
model.W2.3 <- drm((surv * 100) ~ rate, herb, fct = W2.3(), data = data, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2023/2023-112/A92/2023-112_A92_DR Survival.tiff",
...
plot(model.W2.3,
     ...
     ylab = expression(paste("Plant Survival (%)")),
     ylim = c(0, 100),
     #broken = T,
     col = c("darkgreen", "red"),
     pch = c(19, 17),
