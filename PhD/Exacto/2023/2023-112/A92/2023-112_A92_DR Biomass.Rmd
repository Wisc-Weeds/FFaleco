---
title: "Exacto 2023-112 A92 DR Biomass"
...
model.LL2.3 <- drm(biomass ~ rate, herb, fct = LL2.3(), data = data, type = "continuous")
...
EDcomp(model.LL2.3, c((summary(model.LL2.3)$coefficients[4, 1] * 0.5),
       ...
       compMatch = c("reflex", "EXT1490"), type = "absolute", interval = "none", reverse = F, logBase = exp(1))
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2023/2023-112/A92/2023-112_A92_DR Biomass.tiff",
