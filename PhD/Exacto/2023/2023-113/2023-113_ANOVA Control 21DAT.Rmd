---
title: "Exacto 2023-113 ANOVA Control 28 DAT"
...
plot(emm_herb_rate, adjust = "tukey", comparisons = T, CIs = F, alpha = 0.05,  horizontal = T) + 
  geom_point(size = 2) +
  geom_text(aes(label = c("ab", "b", "ab", "ab", "a", "ab",
                          "a", "a", "a", "a", "a", "a")),
            vjust = -0.8, size = 4) +
  ...
  ggsave("2023-113_ANOVA Control 28DAT_HERBxRATE.tiff", units="in", width = 8, height = 6, dpi = 600, compression = "lzw")
