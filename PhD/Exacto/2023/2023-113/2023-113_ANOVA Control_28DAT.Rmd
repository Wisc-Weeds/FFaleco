...
model <- glmmTMB((ve_28dat/100) ~ herb * rate, data = data, family = beta_family())
...
plot(emm_rate, adjust = "tukey", comparisons = T, CIs = F, alpha = 0.05,  horizontal = T) + 
  ...
  ggsave("2023-113_ANOVA Countred_RATE.tiff", units="in", width = 8, height = 6, dpi = 600, compression = "lzw")
