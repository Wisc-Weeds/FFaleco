...
plot(emm_trt, adjust = "tukey", comparisons = F, alpha = 0.05,  horizontal = T) + 
  geom_point(size = 2) +
  geom_text(aes(label = c("e", "cd", "f", "d", "bc", "b", "a", "a", "a", "a")),
            vjust = -0.8, size = 4) +
  ...
  ggsave("ANOVA_redroot_vr_7DAT.tiff", units="in", width = 10, height = 8, dpi = 600, compression = "lzw")
