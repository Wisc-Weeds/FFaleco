...
summary.EXT1494 <- summaryBy(cbind(vr_14dat) ~ rate + name, data = subset(data, name=="EXT1494"),
          FUN=fun)


summary.Pursuit <- summaryBy(cbind(vr_14dat) ~ rate + name, data = subset(data, name=="Pursuit"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-114/Sorghum/2022_114_DR_VR14DAT.tiff",
...
points(x = c(summary(model.LL4)$coefficients[5, 1], 
             summary(model.LL4)$coefficients[6, 1]),
       y = c((summary(model.LL4)$coefficients[3, 1]/2), 
             (summary(model.LL4)$coefficients[4, 1]/2)),
       pch = 8,
       cex = 1.5)
