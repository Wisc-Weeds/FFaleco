---
title: "Exacto 2022-114 Dose Response Redroot biomass"
...
summary.EXT1494 <- summaryBy(cbind(biomass) ~ rate + name, data = subset(data, name=="EXT1494"),
          FUN=fun)


summary.Pursuit <- summaryBy(cbind(biomass) ~ rate + name, data = subset(data, name=="Pursuit"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-114/Sorghum/2022_114_DR_biomass.tiff",
