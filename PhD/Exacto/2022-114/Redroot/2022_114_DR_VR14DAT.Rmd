...
summary.EXT1494 <- summaryBy(cbind(vr_7dat) ~ rate + name, data = subset(data, name=="EXT1494"),
          FUN=fun)


summary.Pursuit <- summaryBy(cbind(vr_7dat) ~ rate + name, data = subset(data, name=="Pursuit"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-114/Redroot/2022_114_DR_VR7DAT.tiff",
