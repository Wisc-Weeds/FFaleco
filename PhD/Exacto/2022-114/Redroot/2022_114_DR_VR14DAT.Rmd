---
title: "Exacto 2022-114 Dose Response Redroot VR14DAT"
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-114/Redroot/DR_Redroot_vr14DAT.tiff",
...
plot(model.LL3,
     type = "average",
     xlab = expression(paste("Imazethapyr dose (g ai ha"^-1, ")")),
...
text(x = 150, y = 25, 
     labels = expression(paste("ED"[50] ~ "Pursuit = 2.4 ("%+-% "0.3)" ^A)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 160, y = 20, 
     labels = expression(paste("ED"[50] ~ "EXT1494 = 6.1 ("%+-% "0.2)" ^B)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 130, y = 5, 
     labels = expression("1x rate: 70 g ai ha" ^-1),
     cex = 1.1,
     col = "black",
     font = 2)
