---
title: "Exacto 2022-108 Dose Response VR14DAT"
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-108/DR_vr14DAT.tiff",
...
text(x = 650, y = 60, 
     labels = expression(paste("ED"[50] ~ "Ratio = 1.6 ("%+-% "0.2)")),
     cex = 1,
     col = "black",
     font = 2)

text(x = 480, y = 55, 
     labels = expression("p-value < 0.05"),
     cex = 1,
     col = "black",
     font = 2)
