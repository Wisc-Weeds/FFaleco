---
title: "Exacto 2022-107_Redroot VR-14DAT"
...
plot(emm_trt, adjust = "tukey", comparisons = F, alpha = 0.05,  horizontal = T) + 
  geom_point(size = 2) +
  geom_text(aes(label = c("f", "d", "g", "e", "cd", "bc", "a", "ab", "ab", "a")),
            vjust = -0.8, size = 4) +
  ...
  ggsave("ANOVA_redroot_vr_14DAT.tiff", units="in", width = 10, height = 8, dpi = 600, compression = "lzw")
