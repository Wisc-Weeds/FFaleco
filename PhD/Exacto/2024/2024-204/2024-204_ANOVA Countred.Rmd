---
title: "Exacto 2024-204 ANOVA Countred"
...
plot(emm_herb_rate, adjust = "tukey", comparisons = T, CIs = F, alpha = 0.1,  horizontal = T) + 
  ...
  ggsave("2024-204_ANOVA Countred_HERBxRATE.tiff", units="in", width = 8, height = 6, dpi = 600, compression = "lzw")
