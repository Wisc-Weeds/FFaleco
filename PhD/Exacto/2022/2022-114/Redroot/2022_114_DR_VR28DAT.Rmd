---
title: "Exacto 2022-114 Dose Response Redroot VR28DAT"
...
summary.EXT1494 <- summaryBy(cbind(vr_28dat) ~ rate + name, data = subset(data, name=="EXT1494"),
          FUN=fun)


summary.Pursuit <- summaryBy(cbind(vr_28dat) ~ rate + name, data = subset(data, name=="Pursuit"),
          FUN=fun)
...
model.LL4<- drm(vr_28dat ~ rate, name, fct = LL.4(),  data = data)
...
model.LL3<- drm(vr_28dat ~ rate, name, fct = LL.3(),  data = data, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-114/Redroot/2022_114_DR_VR28DAT.tiff",
...
plot(model.LL3,
     ...
     ylab = expression(paste("Control 28 DAT (%)")),
     col = c("darkgreen", "red"),
     pch = c(19, 17),
     cex = 1.5,
     cex.axis = 1.3,
