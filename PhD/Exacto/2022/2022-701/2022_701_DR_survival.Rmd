---
title: "Exacto 2022-701 Dose Response Survival"
...
summary.Reflex_EXT1576 <- summaryBy(surv ~ rate + name, data = subset(data, name=="Reflex+EXT1576"),
          FUN=fun)


summary.Reflex_TolexME8470 <- summaryBy(surv ~ rate + name, data = subset(data, name=="Reflex+TolexME8470"),
          FUN=fun)
...
EDcomp(model.LL4, c(50, 50), type = "relative", interval = "none", reverse = FALSE)

EDcomp(model.LL4, c(90, 90), type = "relative", interval = "none", reverse = FALSE)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-701/2022_701_DR_survival.tiff",
...
plot(model.LL4,
     ...
     ylab = expression(paste("Survival 21 DAT (%)")),
     col = c("darkgreen", "red"),
     pch = c(19, 17),
     cex = 1.5,
     cex.axis = 1.3,
