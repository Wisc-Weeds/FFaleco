---
title: "Exacto 2022-701 Dose Response VR14DAT"
...
summary.Reflex_EXT1576 <- summaryBy(vr_14dat ~ rate + name, data = subset(data, name=="Reflex+EXT1576"),
          FUN=fun)


summary.Reflex_TolexME8470 <- summaryBy(vr_14dat ~ rate + name, data = subset(data, name=="Reflex+TolexME8470"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/Exacto/2022-701/2022_701_DR_VR14DAT.tiff",
