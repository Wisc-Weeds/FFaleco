...
model <- glmmTMB(biored ~ trt, data = data, family = beta_family())
...
plot(emm_trt, adjust = "tukey", comparisons = F, alpha = 0.05,  horizontal = T) + 
  ...
  ggsave("2022_115_biored.tiff", units="in", width = 10, height = 8, dpi = 600, compression = "lzw")
