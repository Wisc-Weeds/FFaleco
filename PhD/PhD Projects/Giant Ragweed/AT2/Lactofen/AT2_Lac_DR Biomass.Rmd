...
ED50.AT2 <- ED(model.W2.3, (summary(model.W2.3)$coefficients[3, 1] * 0.5), clevel = "AT2", type = "absolute", interval = "delta")

ED50.AT8.EDGE <- ED(model.W2.3, (summary(model.W2.3)$coefficients[4, 1] * 0.5), clevel = "AT8-EDGE", type = "absolute", interval = "delta")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Giant Ragweed/AT2/Lactofen/AT2_Lac_DR Biomass.tiff",
