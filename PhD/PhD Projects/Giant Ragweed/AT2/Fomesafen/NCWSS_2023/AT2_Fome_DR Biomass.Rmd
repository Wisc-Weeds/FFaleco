...
ED50.AT2 <- ED(model.W1.3, (summary(model.W1.3)$coefficients[3, 1] * 0.5), clevel = "AT2", type = "absolute", interval = "delta")

ED50.AT8.EDGE <- ED(model.W1.3, (summary(model.W1.3)$coefficients[4, 1] * 0.5), clevel = "AT8-EDGE", type = "absolute", interval = "delta")
...
EDcomp(model.W1.3, c((summary(model.W1.3)$coefficients[3, 1] * 0.5),
       ...
       compMatch = c("AT2", "AT8-EDGE"), type = "absolute", interval = "none", reverse = F)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Giant Ragweed/AT2/Fomesafen/NCWSS_2023/AT2_Fome_DR Biomass.tiff",
