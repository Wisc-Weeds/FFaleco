...
ED50.A92 <- ED(model.W1.2, 0.1 , clevel = "A92", type = "absolute", interval = "delta")

ED50.A66 <- ED(model.W1.2, 0.1, clevel = "A66", type = "absolute", interval = "delta")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Bill Stangel_A92/2023/PRE/Flumioxazin/A92_PRE_Flumi_DR Percentcounts.tiff",
...
plot(model.W1.2,
     ...
     ylab = expression(paste("Percent plant count (x 100%)")),
     ylim = c(0, 1),
     col = c("red", "darkgreen"),
     pch = c(19, 17),
     cex = 1.5,
