---
title: "Waterhemp PRE A92 Flumioxazin DR Counts"
...
data <- read.csv("Data Sheet_A92_Flumioxazin PRE.csv")
...
model.W2.3 <- drm(countred ~ rate, pop, fct = W2.3(),  data = data, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Bill Stangel_A92/2023/PRE/Flumioxazin/A92_PRE_Flumi_DR Countred.tiff",
...
plot(model.W2.3,
     type = "average",
     xlab = expression(paste("Flumioxazin rate (g ai ha"^-1, ")")),
     ylab = expression(paste("Count Reduction (%)")),
     ylim = c(0, 150),
     col = c("red", "darkgreen"),
     pch = c(19, 17),
     cex = 1.5,
...
points(x = c(ED50.A92[1, 1], 
             ED50.A66[1, 1]),
       y = c((summary(model.W2.3)$coefficients[3, 1] * 0.5), 
