...
model.W1.2 <- drm(percent_bio ~ rate, herb, fct = W1.2(), data = data_A103, type = "continuous")
...
ED50.fome <- ED(model.W1.2, 0.5, clevel = "fome", type = "absolute", interval = "delta")

ED50.fome.P450 <- ED(model.W1.2, 0.5, clevel = "fome+P450", type = "absolute", interval = "delta")

ED50.fome.GST <- ED(model.W1.2, 0.5, clevel = "fome+GST", type = "absolute", interval = "delta")
