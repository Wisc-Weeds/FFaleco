...
summary.atra <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A101, herb=="atra"),
          FUN=fun)


summary.atra_GST <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A101, herb=="atra+GST"),
          FUN=fun)


summary.atra_P450 <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A101, herb=="atra+P450"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Atrazine/2023/Atrazine_Absolute ED/MIs_Atra_GH_A101_DR Biomass.tiff",
