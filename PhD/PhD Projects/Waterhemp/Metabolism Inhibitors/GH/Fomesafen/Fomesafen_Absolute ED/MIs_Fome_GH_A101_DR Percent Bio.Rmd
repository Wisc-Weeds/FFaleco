...
summary.fome <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome"),
          FUN=fun)


summary.fome_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome+GST"),
          FUN=fun)


summary.fome_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome+P450"),
          FUN=fun)
