...
summary.fome_GSTs <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome+GST"),
          FUN=fun)


summary.fome_P450s <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome+P450"),
          FUN=fun)
...
ED50.fome.P450s <- ED(model.W1.2, 0.5, clevel = "fome+P450", type = "absolute", interval = "delta")

ED50.fome.GSTs <- ED(model.W1.2, 0.5, clevel = "fome+GST", type = "absolute", interval = "delta")
...
tiff(file="C:/Users/felip/OneDrive/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Fomesafen/Fomesafen_Absolute ED/MIs_Fome_GH_A101_DR Percent Bio.tiff",
