...
summary.fome_GSTs <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome+GSTs"),
          FUN=fun)


summary.fome_P450s <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="fome+P450s"),
          FUN=fun)
...
ED50.fome.P450s <- ED(model.W1.2, 0.5, clevel = "fome+P450s", type = "absolute", interval = "delta")

ED50.fome.GSTs <- ED(model.W1.2, 0.5, clevel = "fome+GSTs", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("fome", "fome+P450s"), type = "absolute", interval = "none", reverse = T)


EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("fome", "fome+GSTs"), type = "absolute", interval = "none", reverse = T)
