...
summary.fome <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="fome"),
          FUN=fun)


summary.fome_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="fome+GST"),
          FUN=fun)


summary.fome_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="fome+P450"),
          FUN=fun)
...
model.W1.3 <- drm(percent_bio ~ rate, herb, fct = W1.3(), data = data_A82, type = "continuous")
