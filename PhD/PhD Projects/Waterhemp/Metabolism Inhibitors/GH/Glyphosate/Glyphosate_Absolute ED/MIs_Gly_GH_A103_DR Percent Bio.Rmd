...
model.LL.2 <- drm(percent_bio ~ rate, herb, fct = LL.2(), data = data_A103, type = "continuous")
...
anova(model.LL.2, model.LL4) # p-value > 0.05 means that there is no difference between models. Therefore, we can use model W1.3
...
ED50.gly <- ED(model.LL.2, 0.5, clevel = "gly", type = "absolute", interval = "delta")

ED50.gly.P450 <- ED(model.LL.2, 0.5, clevel = "gly+P450", type = "absolute", interval = "delta")

ED50.gly.GST <- ED(model.LL.2, 0.5, clevel = "gly+GST", type = "absolute", interval = "delta")
