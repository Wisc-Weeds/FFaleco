...
summary.gly <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A103, herb=="gly"),
          FUN=fun)


summary.gly_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A103, herb=="gly+GST"),
          FUN=fun)


summary.gly_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A103, herb=="gly+P450"),
          FUN=fun)
...
model.W2.3 <- drm(percent_bio ~ rate, herb, fct = W2.3(), data = data_A103, type = "continuous")
