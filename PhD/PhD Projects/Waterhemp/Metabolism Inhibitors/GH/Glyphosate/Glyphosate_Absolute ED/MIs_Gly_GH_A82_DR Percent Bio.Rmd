...
model.W1.2 <- drm(percent_bio ~ rate, herb, fct = W1.2(), data = data_A82, type = "continuous")
...
ED50.gly <- ED(model.W1.2, 0.5, clevel = "gly", type = "absolute", interval = "delta")

ED50.gly.P450 <- ED(model.W1.2, 0.5, clevel = "gly+P450", type = "absolute", interval = "delta")

ED50.gly.GST <- ED(model.W1.2, 0.5, clevel = "gly+GST", type = "absolute", interval = "delta")
