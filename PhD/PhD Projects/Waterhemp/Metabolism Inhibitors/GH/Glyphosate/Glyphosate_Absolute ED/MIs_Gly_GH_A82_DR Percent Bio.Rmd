...
summary.gly <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="gly"),
          FUN=fun)


summary.gly_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="gly+GST"),
          FUN=fun)


summary.gly_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="gly+P450"),
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, herb, fct = LL.4(), data = data_A82, type = "continuous")
...
model.W2.3 <- drm(percent_bio ~ rate, herb, fct = W2.3(), data = data_A82, type = "continuous")
