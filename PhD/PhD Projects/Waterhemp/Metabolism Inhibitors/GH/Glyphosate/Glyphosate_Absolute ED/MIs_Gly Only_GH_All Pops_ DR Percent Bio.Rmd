...
ED50.A82 <- ED(model.LL.4, (summary(model.LL.4)$coefficients[9, 1] * 0.5), clevel = "A82", type = "absolute", interval = "delta")

ED50.A101 <- ED(model.LL.4, (summary(model.LL.4)$coefficients[10, 1] * 0.5), clevel = "A101", type = "absolute", interval = "delta")

ED50.A103 <- ED(model.LL.4, (summary(model.LL.4)$coefficients[11, 1] * 0.5), clevel = "A103", type = "absolute", interval = "delta")

ED50.A75 <- ED(model.LL.4, (summary(model.LL.4)$coefficients[12, 1] * 0.5), clevel = "A75", type = "absolute", interval = "delta")
...
EDcomp(model.LL.4, c((summary(model.LL.4)$coefficients[10, 1] * 0.5),
                     (summary(model.LL.4)$coefficients[9, 1] * 0.5)), 
       compMatch = c("A101", "A82"), type = "absolute", interval = "none", reverse = F)


EDcomp(model.LL.4, c((summary(model.LL.4)$coefficients[11, 1] * 0.5),
                     (summary(model.LL.4)$coefficients[9, 1] * 0.5)), 
       compMatch = c("A103", "A82"), type = "absolute", interval = "none", reverse = F)


EDcomp(model.LL.4, c((summary(model.LL.4)$coefficients[12, 1] * 0.5),
                     (summary(model.LL.4)$coefficients[9, 1] * 0.5)), 
