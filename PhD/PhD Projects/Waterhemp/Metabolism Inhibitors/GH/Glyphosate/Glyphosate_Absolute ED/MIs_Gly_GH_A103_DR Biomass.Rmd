...
summary.gly <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A103, herb=="gly"),
          FUN=fun)


summary.gly_GST <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A103, herb=="gly+GST"),
          FUN=fun)


summary.gly_P450 <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A103, herb=="gly+P450"),
          FUN=fun)
...
model.W2.3 <- drm(biomass ~ rate, herb, fct = W2.3(), data = data_A103, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Glyphosate/Glyphosate_Absolute ED/MIs_Gly_GH_A103_DR Biomass.tiff",
