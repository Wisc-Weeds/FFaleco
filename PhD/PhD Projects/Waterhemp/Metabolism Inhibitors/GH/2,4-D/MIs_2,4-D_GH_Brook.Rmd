...
data <- read.csv("Data Sheet_2,4-D_GH_Brook.csv")
...
summary.24D <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data, herb=="2,4D"),
          FUN=fun)


summary.24D_GST <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data, herb=="2,4D+GST"),
          FUN=fun)


summary.24D_P450 <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data, herb=="2,4D+P450"),
          FUN=fun)
