---
title: "Waterhemp MIs GH 2,4-D A82 vs A101 Biomass"
...
data_24D_A82_A101 <- data %>% filter(herb == "2,4D" & pop %in% c("A82", "A101"))
...
summary.24D_A82_A101 <- summaryBy(cbind(biomass) ~ pop + rate, data = data_24D_A82_A101,
          FUN=fun)
...
model.LL4<- drm(biomass ~ rate, pop, fct = LL.4(), data = data_24D_A82_A101, type = "continuous")
...
model.LL3<- drm(biomass ~ rate, pop, fct = LL.3(),  data = data_24D_A82_A101, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/2,4-D/GH_2,4D Only_A82_A101_DR biomass.tiff",
