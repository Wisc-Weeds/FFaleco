...
summary.24D <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A20, herb=="2,4D"),
          FUN=fun)


summary.24D_GST <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A20, herb=="2,4D+GST"),
          FUN=fun)


summary.24D_P450 <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A20, herb=="2,4D+P450"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/2,4-D/2,4-D_Brook_DR_biomass.tiff",
...
text(x = 4000, y = 2.0, 
     labels = expression(paste("ED"[50] ~ "2,4-D= 297.6 ("%+-% "68.6)")),
     cex = 0.95,
     col = "black",
     font = 2)
...
text(x = 5300, y = 1.8, 
     labels = expression(paste("ED"[50] ~ "meso+P450= 193.0 ("%+-% "63.8)")),
     cex = 0.95,
     col = "black",
     font = 2)
...
text(x = 5600, y = 1.6, 
     labels = expression(paste("ED"[50] ~ "meso+GST= 116.6 ("%+-% "37.4)**")),
     cex = 0.95,
     col = "black",
     font = 2)
