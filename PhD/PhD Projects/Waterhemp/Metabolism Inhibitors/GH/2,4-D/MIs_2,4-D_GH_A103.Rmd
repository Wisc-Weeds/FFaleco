...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/2,4-D/GH_2,4-D+MIs_A103_DR biomass.tiff.tiff",
...
text(x = 3600, y = 2.0, 
     labels = expression(paste("ED"[50] ~ "2,4-D= 55.2 ("%+-% "11.0)" ^A)),
     cex = 0.95,
     col = "black",
     font = 2)
...
text(x = 4600, y = 1.8, 
     labels = expression(paste("ED"[50] ~ "2,4-D+GST= 74.6 ("%+-% "14.8)" ^A)),
     cex = 0.95,
     col = "black",
     font = 2)
...
text(x = 5000, y = 1.6, 
     labels = expression(paste("ED"[50] ~ "2,4-D+P450= 174.8 ("%+-% "42.4)" ^B)),
     cex = 0.95,
     col = "black",
     font = 2)
