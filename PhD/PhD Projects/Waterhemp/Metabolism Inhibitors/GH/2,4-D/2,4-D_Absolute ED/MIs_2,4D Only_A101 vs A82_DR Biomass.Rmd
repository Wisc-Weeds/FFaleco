...
data_24D <- data %>% filter(herb == "2,4D", pop == "A82" | pop == "A101")
...
ED50.A82 <- ED(model.W1.3, (summary(model.W1.3)$coefficients[3, 1] * 0.5), clevel = "A82", type = "absolute", interval = "delta")

ED50.A101 <- ED(model.W1.3, (summary(model.W1.3)$coefficients[4, 1] * 0.5), clevel = "A101", type = "absolute", interval = "delta")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/2,4-D/2,4-D_Absolute ED/GH_2,4D Only_A101 vs A82_DR Biomass.tiff",
