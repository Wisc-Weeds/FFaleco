...
ED50.24D <- ED(model.W1.2, 0.5, clevel = "2,4D", type = "absolute", interval = "delta")

ED50.24D.P450 <- ED(model.W1.2, 0.5, clevel = "2,4D+P450", type = "absolute", interval = "delta")

ED50.24D.GST <- ED(model.W1.2, 0.5, clevel = "2,4D+GST", type = "absolute", interval = "delta")
