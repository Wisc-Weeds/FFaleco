...
summary.24D_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="2,4D+GSTs"),
          FUN=fun)


summary.24D_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="2,4D+P450s"),
          FUN=fun)
...
ED50.24D.P450s <- ED(model.W1.2, 0.5, clevel = "2,4D+P450s", type = "absolute", interval = "delta")

ED50.24D.GSTs <- ED(model.W1.2, 0.5, clevel = "2,4D+GSTs", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("2,4D", "2,4D+P450s"), type = "absolute", interval = "none", reverse = T)


EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("2,4D", "2,4D+GSTs"), type = "absolute", interval = "none", reverse = T)
