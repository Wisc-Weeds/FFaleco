...
summary.24D <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="2,4D"),
          FUN=fun)


summary.24D_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="2,4D+GST"),
          FUN=fun)


summary.24D_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="2,4D+P450"),
          FUN=fun)
