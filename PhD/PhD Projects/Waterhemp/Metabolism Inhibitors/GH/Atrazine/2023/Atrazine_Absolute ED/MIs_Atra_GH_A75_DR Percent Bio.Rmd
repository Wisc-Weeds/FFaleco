...
model.LL.2 <- drm(percent_bio ~ rate, herb, fct = LL.2(), data = data_A75, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Atrazine/2023/Atrazine_Absolute ED/MIs_Atra_GH_A75_DR Percent Bio.tiff",
...
plot(model.LL.2,
     ...
     ylab = expression(paste("A75 Biomass (x 100%)")),
     ylim = c(0, 1),
     #broken = T,
