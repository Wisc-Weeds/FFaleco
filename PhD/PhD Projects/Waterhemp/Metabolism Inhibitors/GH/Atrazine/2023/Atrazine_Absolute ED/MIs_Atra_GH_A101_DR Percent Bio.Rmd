...
summary.atra <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="atra"),
          FUN=fun)


summary.atra_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="atra+GST"),
          FUN=fun)


summary.atra_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="atra+P450"),
          FUN=fun)
...
ED50.atra <- ED(model.W1.3, (summary(model.W1.3)$coefficients[4, 1] * 0.5), clevel = "atra", type = "absolute", interval = "delta")

ED50.atra.P450 <- ED(model.W1.3, (summary(model.W1.3)$coefficients[5, 1] * 0.5), clevel = "atra+P450", type = "absolute", interval = "delta")

ED50.atra.GST <- ED(model.W1.3, (summary(model.W1.3)$coefficients[6, 1] * 0.5), clevel = "atra+GST", type = "absolute", interval = "delta")
