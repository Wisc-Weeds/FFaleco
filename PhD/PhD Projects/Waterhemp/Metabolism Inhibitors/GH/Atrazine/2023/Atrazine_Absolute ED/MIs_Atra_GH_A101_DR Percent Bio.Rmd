...
summary.atra_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="atra+GSTs"),
          FUN=fun)


summary.atra_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="atra+P450s"),
          FUN=fun)
...
ED50.atra.P450s <- ED(model.W1.2, 0.5, clevel = "atra+P450s", type = "absolute", interval = "delta")

ED50.atra.GSTs <- ED(model.W1.2, 0.5, clevel = "atra+GSTs", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("atra", "atra+P450s"), type = "absolute", interval = "none", reverse = T)


EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("atra", "atra+GSTs"), type = "absolute", interval = "none", reverse = T)
