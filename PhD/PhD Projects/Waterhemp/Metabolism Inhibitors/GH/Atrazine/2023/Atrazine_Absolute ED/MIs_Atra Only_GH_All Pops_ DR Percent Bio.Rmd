...
model.LL.2 <- drm(percent_bio ~ rate, pop, fct = LL.2(), data = data_atra, type = "continuous")

plot(fitted(model.LL.2), residuals(model.LL.2))

qqnorm(residuals(model.LL.2))
...
anova(model.LL.2, model.LL4) # p-value > 0.05 means that there is no difference between models. Therefore, we can use model LL.3
...
ED50.A82 <- ED(model.LL.2, 0.5, clevel = "A82", type = "absolute", interval = "delta")

ED50.A101 <- ED(model.LL.2, 0.5, clevel = "A101", type = "absolute", interval = "delta")

ED50.A103 <- ED(model.LL.2, 0.5, clevel = "A103", type = "absolute", interval = "delta")

ED50.A75 <- ED(model.LL.2, 0.5, clevel = "A75", type = "absolute", interval = "delta")
...
compParm(model.LL.2, strVal = "b", operator = "-")


# Comparing d parameter (upper limit)
compParm(model.LL.2, strVal = "d", operator = "-")


# Comparing e parameter (Infletion Point)
compParm(model.LL.2, strVal = "e", operator = "-") # Remember that for assymetric models, the paramenter"e" does not reflect the ED50. 
