...
ED50.atra <- ED(model.W1.2, 0.5, clevel = "atra", type = "absolute", interval = "delta")

ED50.atra.P450 <- ED(model.W1.2, 0.5, clevel = "atra+P450", type = "absolute", interval = "delta")

ED50.atra.GST <- ED(model.W1.2, 0.5, clevel = "atra+GST", type = "absolute", interval = "delta")
