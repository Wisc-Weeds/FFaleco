...
ED50.atra <- ED(model.LL.2, 0.5, clevel = "atra", type = "absolute", interval = "delta")

ED50.atra.P450 <- ED(model.LL.2, 0.5, clevel = "atra+P450", type = "absolute", interval = "delta")

ED50.atra.GST <- ED(model.LL.2, 0.5, clevel = "atra+GST", type = "absolute", interval = "delta")
...
plot(model.LL.2,
     ...
     ylab = expression(paste("A103 Biomass (x 100%)")),
     ylim = c(0, 1),
     #broken = T,
