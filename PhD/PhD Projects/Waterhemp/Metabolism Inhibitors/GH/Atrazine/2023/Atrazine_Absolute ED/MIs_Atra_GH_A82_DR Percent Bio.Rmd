...
summary.atra <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="atra"),
          FUN=fun)


summary.atra_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="atra+GST"),
          FUN=fun)


summary.atra_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A82, herb=="atra+P450"),
          FUN=fun)
...
model.LL.3 <- drm(percent_bio ~ rate, herb, fct = LL.3(), data = data_A82, type = "continuous")
...
#tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Atrazine/2023/Atrazine_Absolute ED/MIs_Atra_GH_A101_DR Percent Bio.tiff",
