...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Atrazine/GH_Atra+MIs_A82_DR biomass.tiff",
...
text(x = 5100, y = 2.1, 
     labels = expression(paste("ED"[50] ~ "atra+P450 = 74.1 ("%+-% "20.4)" ^A)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 3900, y = 1.9, 
     labels = expression(paste("ED"[50] ~ "atra = 94.6 ("%+-% "16.2)" ^A)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 5300, y = 1.7, 
     labels = expression(paste("ED"[50] ~ "atra+GST = 201.0 ("%+-% "32.8)" ^B)),
     cex = 1.0,
     col = "black",
     font = 2)
