...
summary.atra <- summaryBy(cbind(biomass) ~ pop + rate, data = data_atra,
          FUN=fun)
...
model.LL3<- drm(biomass ~ rate, pop, fct = LL.3(),  data = data_atra, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Atrazine/GH_Atra Only_All Pops_DR biomass.tiff",
...
text(x = 4500, y = 2.3, 
     labels = expression(paste("ED"[50] ~ "A75 = 728.1 ("%+-% "146.2)" ^A)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 5000, y = 2.1, 
     labels = expression(paste("ED"[50] ~ "A103 = 488.9 ("%+-% "128.0)" ^AB)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 4700, y = 1.9, 
     labels = expression(paste("ED"[50] ~ "A101 = 200.7 ("%+-% "71.0)" ^BC)),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 4100, y = 1.7, 
     labels = expression(paste("ED"[50] ~ "A82 = 71.6 ("%+-% "29.7)" ^C)),
     cex = 1.0,
     col = "black",
     font = 2)
