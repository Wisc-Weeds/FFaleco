...
model.LL.3<- drm(biomass ~ rate, pop, fct = LL.3(),  data = data_24D, type = "continuous")
...
summary(model.LL.3) # NO parameter c (lower limit). It means lower limit was set to zero.
...
ED(model.LL.3, c(50), type = "relative") 

ED(model.LL.3, c(0.5), type = "absolute") 



ED(model.W1.3, c(0.5), type = "absolute") 
