---
title: "Waterhemp MIs GH 2,4-D Biomass"
...
model.LL4<- drm(biomass ~ rate, pop, fct = LL.4(), data = data_24D, type = "continuous")
...
model.W1.3 <- drm(biomass ~ rate, pop, fct = W1.3(),  data = data_24D, type = "continuous")
...
ED(model.W1.3, (summary(model.W1.3)$coefficients[5, 1] * 0.5), clevel = "A82", type = "absolute", interval = "delta")

ED(model.W1.3, (summary(model.W1.3)$coefficients[6, 1] * 0.5), clevel = "A101", type = "absolute", interval = "delta")

ED(model.W1.3, (summary(model.W1.3)$coefficients[7, 1] * 0.5), clevel = "A103", type = "absolute", interval = "delta")

ED(model.W1.3, (summary(model.W1.3)$coefficients[8, 1] * 0.5), clevel = "A75", type = "absolute", interval = "delta")
