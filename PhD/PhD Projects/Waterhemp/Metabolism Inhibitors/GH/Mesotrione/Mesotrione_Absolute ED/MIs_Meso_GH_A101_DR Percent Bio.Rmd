...
summary.meso_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="meso+GST"),
          FUN=fun)


summary.meso_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="meso+P450"),
          FUN=fun)
