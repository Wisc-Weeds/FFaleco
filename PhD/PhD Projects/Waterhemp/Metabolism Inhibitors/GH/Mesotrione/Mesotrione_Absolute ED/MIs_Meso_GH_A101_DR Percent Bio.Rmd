...
summary.meso_GSTs <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="meso+GST"),
          FUN=fun)


summary.meso_P450s <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A101, herb=="meso+P450"),
          FUN=fun)
...
ED50.meso.P450s <- ED(model.W1.2, 0.5, clevel = "meso+P450", type = "absolute", interval = "delta")

ED50.meso.GSTs <- ED(model.W1.2, 0.5, clevel = "meso+GST", type = "absolute", interval = "delta")
...
tiff(file="C:/Users/felip/OneDrive/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Mesotrione/Mesotrione_Absolute ED/GH_Meso_A101_DR Percent Bio.tiff",
