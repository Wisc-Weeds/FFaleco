...
summary.meso <- summaryBy(cbind(percent_bio) ~ pop + rate, data = subset(data_meso),
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, pop, fct = LL.4(), data = data_meso, type = "continuous")
...
model.W1.3 <- drm(percent_bio ~ rate, pop, fct = W1.3(),  data = data_meso, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Mesotrione/Mesotrione_Absolute ED/GH_Meso Only_All Pops_DR Percent Bio.tiff",
