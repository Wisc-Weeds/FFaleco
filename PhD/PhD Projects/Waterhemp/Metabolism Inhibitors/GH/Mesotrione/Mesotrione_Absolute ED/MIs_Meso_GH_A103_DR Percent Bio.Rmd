...
summary.meso <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A103, herb=="meso"),
          FUN=fun)


summary.meso_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A103, herb=="meso+GST"),
          FUN=fun)


summary.meso_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A103, herb=="meso+P450"),
          FUN=fun)
...
ED50.meso.P450 <- ED(model.W1.2, 0.5, clevel = "meso+P450", type = "absolute", interval = "delta")

ED50.meso.GST <- ED(model.W1.2, 0.5, clevel = "meso+GST", type = "absolute", interval = "delta")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/Mesotrione/Mesotrione_Absolute ED/GH_Meso_A82_DR Percent Bio.tiff",
...
plot(model.W1.2,
     ...
     ylab = expression(paste("A82 Biomass (%)")),
     ylim = c(0, 100),
     #broken = T,
