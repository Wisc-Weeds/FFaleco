...
summary.24D <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A101, herb=="2,4D"),
          FUN=fun)


summary.24D_GST <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A101, herb=="2,4D+GST"),
          FUN=fun)


summary.24D_P450 <- summaryBy(cbind(biomass) ~ herb + rate, data = subset(data_A101, herb=="2,4D+P450"),
          FUN=fun)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH/2,4-D/2,4-D_Absolute ED/GH_2,4-D_A101_DR Biomass.tiff",
