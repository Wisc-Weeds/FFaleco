...
summary.meso <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A75, herb=="meso"),
          FUN=fun)


summary.meso_GST <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A75, herb=="meso+GST"),
          FUN=fun)


summary.meso_P450 <- summaryBy(cbind(percent_bio) ~ herb + rate, data = subset(data_A75, herb=="meso+P450"),
          FUN=fun)
