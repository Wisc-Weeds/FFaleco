...
model.W1.3<- drm(biomass ~ rate, herb, fct = W1.3(),  data = data, type = "continuous")
...
EDcomp(model.W1.3, c(90, 90), type = "relative", interval = "none", reverse = F)
...
compParm(model.W1.3, strVal = "e", operator = "-") 
...
text(x = 350, y = 1.5, 
     labels = expression(paste("ED"[50] ~ "meso = 12.3 ("%+-% "2.5)")),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 440, y = 1.3, 
     labels = expression(paste("ED"[50] ~ "meso+P450 = 6.1 ("%+-% "1.6)")),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 450, y = 1.1, 
     labels = expression(paste("ED"[50] ~ "meso+GST = 5.1 ("%+-% "1.3)*")),
     cex = 1.0,
     col = "black",
     font = 2)
