...
data.A82.24D.P450 <- data %>% filter(pop == "A82", herb == "2,4D+P450")
...
summary.A82.24D.P450 <- summaryBy(cbind(biomass) ~ pop + rate + temp + herb, data = subset(data.A82.24D.P450),
          FUN=fun)
...
model.LL4 <- drm(biomass ~ rate, temp, fct = LL.4(), data = data.A82.24D.P450, type = "continuous")
...
model.LL2.3 <- drm(biomass ~ rate, temp, fct = LL2.3(), data = data.A82.24D.P450, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/2,4-D_Absolute ED/MIs_2,4-D+P450_GC_A82_ DR Biomass.tiff",
...
plot(model.LL2.3,
     type = "average",
     xlab = expression(paste("2,4-D + P450 rate (g ae ha"^-1, ")")),
