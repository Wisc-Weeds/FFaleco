...
data.A101.24D.P450 <- data %>% filter(pop == "A101", herb == "2,4D+P450")
...
summary.A101.24D.P450 <- summaryBy(cbind(biomass) ~ pop + rate + temp + herb, data = subset(data.A101.24D.P450),
          FUN=fun)
...
model.LL4 <- drm(biomass ~ rate, temp, fct = LL.4(), data = data.A101.24D.P450, type = "continuous")
...
model.W1.3 <- drm(biomass ~ rate, temp, fct = W1.3(), data = data.A101.24D.P450, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/2,4-D_Absolute ED/MIs_2,4-D+P450_GC_A101_ DR Biomass.tiff",
