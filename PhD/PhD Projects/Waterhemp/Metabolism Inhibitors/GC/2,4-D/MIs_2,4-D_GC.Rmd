...
data_24D_high <- data %>% filter(herb == "2,4D", temp == "H")
...
summary.24D_high <- summaryBy(cbind(biomass) ~ pop + rate + temp, data = subset(data_24D_high),
          FUN=fun)
...
model.LL4<- drm(biomass ~ rate, pop, fct = LL.4(), data = data_24D_high, type = "continuous")
...
model.LL3<- drm(biomass ~ rate, pop, fct = LL.3(),  data = data_24D_high, type = "continuous")
...
data_24D_low <- data %>% filter(herb == "2,4D", temp == "L")
...
summary.24D_low<- summaryBy(cbind(biomass) ~ pop + rate + temp, data = subset(data_24D_low),
          FUN=fun)
...
model.LL4<- drm(biomass ~ rate, pop, fct = LL.4(), data = data_24D_low, type = "continuous")
...
model.LL3<- drm(biomass ~ rate, pop, fct = LL.3(),  data = data_24D_low, type = "continuous")
