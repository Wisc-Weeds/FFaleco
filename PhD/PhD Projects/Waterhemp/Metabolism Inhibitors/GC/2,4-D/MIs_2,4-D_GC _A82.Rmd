...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/GC_2,4-D Only_A82_DR biomass.tiff",
...
plot(model.LL3,
     type = "average",
     xlab = expression(paste("2,4-D dose (g ae ha"^-1, ")")),
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/GC_2,4-D+P450_A82_DR biomass.tiff",
     width = 10, height = 8, units = "in", res = 600, compression = "lzw")
...
plot(model.LL3,
     type = "average",
     xlab = expression(paste("2,4-D+P450 dose (g ae ha"^-1, ")")),
     ylab = expression(paste("A82 biomass (g plant"^-1, ")")),
     ylim = c(0, 4),
     col = c("darkgreen", "red"),
     pch = c(19, 17),
...
text(x = 3450, y = 1.5, 
     labels = expression(paste("ED"[50] ~ "elevated = 22.9 ("%+-% "17.6)" ^A)),
     cex = 1.2,
     col = "black",
     font = 2)
...
text(x = 3500, y = 1.3, 
     labels = expression(paste("ED"[50] ~ "ambient = 109.9 ("%+-% "14.6)" ^B)),
     cex = 1.2,
     col = "black",
     font = 2)
