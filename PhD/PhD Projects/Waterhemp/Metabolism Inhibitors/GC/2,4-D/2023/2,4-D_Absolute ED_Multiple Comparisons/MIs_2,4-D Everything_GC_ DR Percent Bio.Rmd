...
ED50.A82.24D.elevated <- ED(model.W1.2, 0.5, clevel = "A82+2,4D+elevated", type = "absolute", interval = "delta")

ED50.A82.24D.ambient <- ED(model.W1.2, 0.5, clevel = "A82+2,4D+ambient", type = "absolute", interval = "delta")



ED50.A101.24D.elevated <- ED(model.W1.2, 0.5, clevel = "A101+2,4D+elevated", type = "absolute", interval = "delta")

ED50.A101.24D.ambient <- ED(model.W1.2, 0.5, clevel = "A101+2,4D+ambient", type = "absolute", interval = "delta")



ED50.A101.24D.P450.elevated <- ED(model.W1.2, 0.5, clevel = "A101+2,4D+P450+elevated", type = "absolute", interval = "delta")

ED50.A101.24D.P450.ambient<- ED(model.W1.2, 0.5, clevel = "A101+2,4D+P450+ambient", type = "absolute", interval = "delta")



ED50.A101.24D.GST.elevated <- ED(model.W1.2, 0.5, clevel = "A101+2,4D+GST+elevated", type = "absolute", interval = "delta")

ED50.A101.24D.GST.ambient <- ED(model.W1.2, 0.5, clevel = "A101+2,4D+GST+ambient", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A82+2,4D+elevated", "A82+2,4D+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+2,4D+elevated", "A101+2,4D+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+2,4D+P450+elevated", "A101+2,4D+P450+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+2,4D+GST+elevated", "A101+2,4D+GST+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/2023/2,4-D_Absolute ED_Multiple Comparisons/MIs_2,4-D Everything_GC_ DR Percent Bio.tiff",
...
points(x = c(ED50.A82.24D.elevated [1, 1],
             ED50.A82.24D.ambient [1, 1],
             ED50.A101.24D.elevated [1, 1],
             ED50.A101.24D.ambient [1, 1],
             ED50.A101.24D.P450.elevated [1, 1],
             ED50.A101.24D.P450.ambient [1, 1],
             ED50.A101.24D.GST.elevated [1, 1],
             ED50.A101.24D.GST.ambient [1, 1]),
