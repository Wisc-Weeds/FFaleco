---
title: "Waterhemp MIs GC Fomesafen Percent Biomass"
...
data <- read.csv("Data Sheet_Fome_GC.csv")
...
ED50.A106.fome.elevated <- ED(model.W1.2, 0.5, clevel = "A106+fome+elevated", type = "absolute", interval = "delta")

ED50.A106.fome.ambient <- ED(model.W1.2, 0.5, clevel = "A106+fome+ambient", type = "absolute", interval = "delta")



ED50.A101.fome.elevated <- ED(model.W1.2, 0.5, clevel = "A101+fome+elevated", type = "absolute", interval = "delta")

ED50.A101.fome.ambient <- ED(model.W1.2, 0.5, clevel = "A101+fome+ambient", type = "absolute", interval = "delta")



ED50.A101.fome.P450.elevated <- ED(model.W1.2, 0.5, clevel = "A101+fome+P450+elevated", type = "absolute", interval = "delta")

ED50.A101.fome.P450.ambient<- ED(model.W1.2, 0.5, clevel = "A101+fome+P450+ambient", type = "absolute", interval = "delta")



ED50.A101.fome.GST.elevated <- ED(model.W1.2, 0.5, clevel = "A101+fome+GST+elevated", type = "absolute", interval = "delta")

ED50.A101.fome.GST.ambient <- ED(model.W1.2, 0.5, clevel = "A101+fome+GST+ambient", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A106+fome+elevated", "A106+fome+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+fome+elevated", "A101+fome+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+fome+P450+elevated", "A101+fome+P450+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+fome+GST+elevated", "A101+fome+GST+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Fomesafen/Fomesafen_Absolute ED_Multiple Comparisons/MIs_Fome Everything_GC_ DR Percent Bio.tiff",
...
points(x = c(ED50.A106.fome.elevated [1, 1],
             ED50.A106.fome.ambient [1, 1],
             ED50.A101.fome.elevated [1, 1],
             ED50.A101.fome.ambient [1, 1],
             ED50.A101.fome.P450.elevated [1, 1],
             ED50.A101.fome.P450.ambient [1, 1],
             ED50.A101.fome.GST.elevated [1, 1],
             ED50.A101.fome.GST.ambient [1, 1]),
