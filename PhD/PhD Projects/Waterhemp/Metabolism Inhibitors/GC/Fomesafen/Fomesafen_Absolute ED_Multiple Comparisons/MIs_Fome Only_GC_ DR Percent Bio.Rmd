...
data.fome <- data %>% filter(herb == "fome")
...
summary <- summaryBy(cbind(percent_bio) ~ treat + rate, data = data.fome,
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, treat, fct = LL.4(), data = data.fome, type = "continuous")
...
model.W1.2 <- drm(percent_bio ~ rate, treat, fct = W1.2(), data = data.fome, type = "continuous")
...
ED50.A106.fome.increased <- ED(model.W1.2, 0.5, clevel = "A106+fome+increased", type = "absolute", interval = "delta")

ED50.A106.fome.ambient <- ED(model.W1.2, 0.5, clevel = "A106+fome+ambient", type = "absolute", interval = "delta")



ED50.A101.fome.increased <- ED(model.W1.2, 0.5, clevel = "A101+fome+increased", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A106+fome+increased", "A106+fome+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+fome+increased", "A101+fome+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Fomesafen/Fomesafen_Absolute ED_Multiple Comparisons/MIs_Fome Only_GC_ DR Percent Bio.tiff",
...
points(x = c(ED50.A106.fome.increased [1, 1],
             ED50.A106.fome.ambient [1, 1],
             ED50.A101.fome.increased [1, 1],
