...
data.A82.atra <- data %>% filter(pop == "A82")
...
model.W2.3 <- drm(biomass ~ rate, temp, fct = W2.3(), data = data.A82.atra, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Atrazine/2023/MIs_Atrazine Only_GC_A82_ DR Biomass.tiff",
