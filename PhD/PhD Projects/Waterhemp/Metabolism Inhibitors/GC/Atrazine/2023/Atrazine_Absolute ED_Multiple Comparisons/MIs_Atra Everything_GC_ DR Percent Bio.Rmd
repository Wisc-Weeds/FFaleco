---
title: "Waterhemp MIs GC Atrazine Percent Biomass"
...
ED50.A82.atra.elevated <- ED(model.W1.2, 0.5, clevel = "A82+atra+elevated", type = "absolute", interval = "delta")

ED50.A82.atra.ambient <- ED(model.W1.2, 0.5, clevel = "A82+atra+ambient", type = "absolute", interval = "delta")



ED50.A101.atra.elevated <- ED(model.W1.2, 0.5, clevel = "A101+atra+elevated", type = "absolute", interval = "delta")

ED50.A101.atra.ambient <- ED(model.W1.2, 0.5, clevel = "A101+atra+ambient", type = "absolute", interval = "delta")



ED50.A101.atra.P450.elevated <- ED(model.W1.2, 0.5, clevel = "A101+atra+P450+elevated", type = "absolute", interval = "delta")

ED50.A101.atra.P450.ambient<- ED(model.W1.2, 0.5, clevel = "A101+atra+P450+ambient", type = "absolute", interval = "delta")



ED50.A101.atra.GST.elevated <- ED(model.W1.2, 0.5, clevel = "A101+atra+GST+elevated", type = "absolute", interval = "delta")

ED50.A101.atra.GST.ambient <- ED(model.W1.2, 0.5, clevel = "A101+atra+GST+ambient", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A82+atra+elevated", "A82+atra+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+atra+elevated", "A101+atra+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+atra+P450+elevated", "A101+atra+P450+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+atra+GST+elevated", "A101+atra+GST+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Atrazine/2023/Atrazine_Absolute ED_Multiple Comparisons/MIs_Atra Everything_GC_ DR Percent Bio.tiff",
...
plot(model.W1.2,
     type = "average",
     xlab = expression(paste("Atrazine rate (g ae ha"^-1, ")")),
...
points(x = c(ED50.A82.atra.elevated [1, 1],
             ED50.A82.atra.ambient [1, 1],
             ED50.A101.atra.elevated [1, 1],
             ED50.A101.atra.ambient [1, 1],
             ED50.A101.atra.P450.elevated [1, 1],
             ED50.A101.atra.P450.ambient [1, 1],
             ED50.A101.atra.GST.elevated [1, 1],
             ED50.A101.atra.GST.ambient [1, 1]),
