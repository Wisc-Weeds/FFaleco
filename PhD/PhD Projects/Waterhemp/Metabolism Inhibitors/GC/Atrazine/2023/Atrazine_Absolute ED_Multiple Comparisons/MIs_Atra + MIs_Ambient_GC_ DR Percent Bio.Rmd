...
summary <- summaryBy(cbind(percent_bio) ~ treat + rate, data = data.24D.MIs.ambient,
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, treat, fct = LL.4(), data = data.24D.MIs.ambient, type = "continuous")
...
model.W1.2 <- drm(percent_bio ~ rate, treat, fct = W1.2(), data = data.24D.MIs.ambient, type = "continuous")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+2,4D+P450+ambient", "A101+2,4D+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+2,4D+GST+ambient", "A101+2,4D+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/2023/2,4-D_Absolute ED_Multiple Comparisons/MIs_2,4-D + MIs_Ambient_GC_ DR Percent Bio.tiff",
...
points(x = c(ED50.A101.24D.ambient [1, 1],
