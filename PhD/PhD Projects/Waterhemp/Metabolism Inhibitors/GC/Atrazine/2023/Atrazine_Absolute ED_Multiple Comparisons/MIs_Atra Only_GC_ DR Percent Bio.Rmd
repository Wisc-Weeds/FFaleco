...
model.W1.2 <- drm(percent_bio ~ rate, treat, fct = W1.2(), data = data.atra, type = "continuous")
...
ED50.A82.atra.increased <- ED(model.W1.2, 0.5, clevel = "A82+atra+increased", type = "absolute", interval = "delta")

ED50.A82.atra.ambient <- ED(model.W1.2, 0.5, clevel = "A82+atra+ambient", type = "absolute", interval = "delta")



ED50.A101.atra.increased <- ED(model.W1.2, 0.5, clevel = "A101+atra+increased", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A82+atra+increased", "A82+atra+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+atra+increased", "A101+atra+ambient"), type = "absolute", interval = "none", reverse = T)
...
points(x = c(ED50.A82.atra.increased [1, 1],
             ED50.A82.atra.ambient [1, 1],
             ED50.A101.atra.increased [1, 1],
