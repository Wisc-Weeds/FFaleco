...
data.101.atra <- data %>% filter(pop == "A101", herb == "atra")
...
summary.A101.atra <- summaryBy(cbind(biomass) ~ pop + rate + temp + herb, data = subset(data.101.atra),
          FUN=fun)
...
model.LL4 <- drm(biomass ~ rate, temp, fct = LL.4(), data = data.101.atra, type = "continuous")
...
model.W2.3 <- drm(biomass ~ rate, temp, fct = W2.3(), data = data.101.atra, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Atrazine/2023/MIs_Atrazine Only_GC_A101_ DR Biomass.tiff",
