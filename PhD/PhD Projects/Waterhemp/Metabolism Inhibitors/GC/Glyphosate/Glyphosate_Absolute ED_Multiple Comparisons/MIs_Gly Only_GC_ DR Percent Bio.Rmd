...
ED50.A106.gly.increased <- ED(model.W1.2, 0.5, clevel = "A106+gly+increased", type = "absolute", interval = "delta")

ED50.A106.gly.ambient <- ED(model.W1.2, 0.5, clevel = "A106+gly+ambient", type = "absolute", interval = "delta")



ED50.A101.gly.increased <- ED(model.W1.2, 0.5, clevel = "A101+gly+increased", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A106+gly+increased", "A106+gly+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+gly+increased", "A101+gly+ambient"), type = "absolute", interval = "none", reverse = T)
...
points(x = c(ED50.A106.gly.increased [1, 1],
             ED50.A106.gly.ambient [1, 1],
             ED50.A101.gly.increased [1, 1],
