...
summary <- summaryBy(cbind(percent_bio) ~ treat + rate, data = data.gly,
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, treat, fct = LL.4(), data = data.gly, type = "continuous")
...
model.W1.2 <- drm(percent_bio ~ rate, treat, fct = W1.2(), data = data.gly, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Glyphosate/Glyphosate_Absolute ED_Multiple Comparisons/MIs_Gly Only_GC_ DR Percent Bio.tiff",
