...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/GC_Meso Only_A82_DR biomass.tiff",
...
text(x = 340, y = 3.0, 
     labels = expression("Elevated 0x biomass = 5.7 ("%+-% "0.2)" ^A),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 330, y = 2.7, 
     labels = expression("Ambient 0x biomass = 3.6 ("%+-% "0.2)" ^B),
     cex = 1.0,
     col = "black",
     font = 2)
