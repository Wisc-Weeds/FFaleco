...
data_A82_high <- data %>% filter(pop == "A82", temp == "H")
...
summary.A82_high <- summaryBy(cbind(biomass) ~ pop + rate + temp + herb, data = subset(data_A82_high),
          FUN=fun)
...
model.LL4<- drm(biomass ~ rate, herb, fct = LL.4(), data = data_A82_high, type = "continuous")
...
model.LL3<- drm(biomass ~ rate, herb, fct = LL.3(),  data = data_A82_high, type = "continuous")
...
data_A82_low <- data %>% filter(pop == "A82", temp == "L")
...
summary.A82_low <- summaryBy(cbind(biomass) ~ pop + rate + temp + herb, data = subset(data_A82_low),
          FUN=fun)
...
model.LL4<- drm(biomass ~ rate, herb, fct = LL.4(), data = data_A82_low, type = "continuous")
...
model.LL3<- drm(biomass ~ rate, herb, fct = LL.3(),  data = data_A82_low, type = "continuous")
