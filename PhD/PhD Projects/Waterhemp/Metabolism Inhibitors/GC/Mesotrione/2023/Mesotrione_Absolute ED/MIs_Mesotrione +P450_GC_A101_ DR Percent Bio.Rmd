...
summary.A101.24D.P450 <- summaryBy(cbind(percent_bio) ~ pop + rate + temp + herb, data = subset(data.A101.24D.P450),
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, temp, fct = LL.4(), data = data.A101.24D.P450, type = "continuous")
...
model.W1.2 <- drm(percent_bio ~ rate, temp, fct = W1.2(), data = data.A101.24D.P450, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/2,4-D/2023/2,4-D_Absolute ED/MIs_2,4-D+P450_GC_A101_ DR Percent Bio.tiff",
