...
data.A82.meso <- data %>% filter(pop == "A82")
...
model.W1.3 <- drm(biomass ~ rate, temp, fct = W1.3(), data = data.A82.meso, type = "continuous")
...
EDcomp(model.W1.3, c((summary(model.W1.3)$coefficients[4, 1] * 0.5),
       ...
       compMatch = c("ambient", "elevated"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/2023/Mesotrione_Absolute ED/MIs_Mesotrione Only_GC_A82_ DR Biomass.tiff",
