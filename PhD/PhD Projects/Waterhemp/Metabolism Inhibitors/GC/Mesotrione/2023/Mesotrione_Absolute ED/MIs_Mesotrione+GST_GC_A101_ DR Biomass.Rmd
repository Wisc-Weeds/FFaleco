...
summary.A101.meso.GST <- summaryBy(cbind(biomass) ~ pop + rate + temp + herb, data = subset(data.A101.meso.GST),
          FUN=fun)
...
model.LL4 <- drm(biomass ~ rate, temp, fct = LL.4(), data = data.A101.meso.GST, type = "continuous")
...
model.W2.3 <- drm(biomass ~ rate, temp, fct = W2.3(), data = data.A101.meso.GST, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/2023/Mesotrione_Absolute ED/MIs_Mesotrione+GST_GC_A101_ DR Biomass.tiff",
