---
title: "Waterhemp MIs GC Meso Percent Biomass"
...
data.meso.MIs.ambient <- data %>% filter(pop == "A101", temp == "ambient")
...
summary <- summaryBy(cbind(percent_bio) ~ treat + rate, data = data.meso.MIs.ambient,
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, treat, fct = LL.4(), data = data.meso.MIs.ambient, type = "continuous")
...
model.W2.2 <- drm(percent_bio ~ rate, treat, fct = W2.2(), data = data.meso.MIs.ambient, type = "continuous")
...
ED50.A101.meso.ambient <- ED(model.W2.2, 0.5, clevel = "A101+meso+ambient", type = "absolute", interval = "delta")


ED50.A101.meso.P450.ambient <- ED(model.W2.2, 0.5, clevel = "A101+meso+P450+ambient", type = "absolute", interval = "delta")


ED50.A101.meso.GST.ambient <- ED(model.W2.2, 0.5, clevel = "A101+meso+GST+ambient", type = "absolute", interval = "delta")
...
EDcomp(model.W2.2, c(0.5, 0.5), 
       compMatch = c("A101+meso+P450+ambient", "A101+meso+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W2.2, c(0.5, 0.5), 
       compMatch = c("A101+meso+GST+ambient", "A101+meso+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/2023/Mesotrione_Absolute ED_Multiple Comparisons/MIs_Meso + MIs_Ambient_GC_ DR Percent Bio.tiff",
...
points(x = c(ED50.A101.meso.ambient [1, 1],
