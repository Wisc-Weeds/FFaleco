...
ED50.A82.meso.elevated <- ED(model.W1.2, 0.5, clevel = "A82+meso+elevated", type = "absolute", interval = "delta")

ED50.A82.meso.ambient <- ED(model.W1.2, 0.5, clevel = "A82+meso+ambient", type = "absolute", interval = "delta")



ED50.A101.meso.elevated <- ED(model.W1.2, 0.5, clevel = "A101+meso+elevated", type = "absolute", interval = "delta")

ED50.A101.meso.ambient <- ED(model.W1.2, 0.5, clevel = "A101+meso+ambient", type = "absolute", interval = "delta")



ED50.A101.meso.P450.elevated <- ED(model.W1.2, 0.5, clevel = "A101+meso+P450+elevated", type = "absolute", interval = "delta")

ED50.A101.meso.P450.ambient<- ED(model.W1.2, 0.5, clevel = "A101+meso+P450+ambient", type = "absolute", interval = "delta")



ED50.A101.meso.GST.elevated <- ED(model.W1.2, 0.5, clevel = "A101+meso+GST+elevated", type = "absolute", interval = "delta")

ED50.A101.meso.GST.ambient <- ED(model.W1.2, 0.5, clevel = "A101+meso+GST+ambient", type = "absolute", interval = "delta")
...
EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A82+meso+elevated", "A82+meso+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+meso+elevated", "A101+meso+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+meso+P450+elevated", "A101+meso+P450+ambient"), type = "absolute", interval = "none", reverse = T)



EDcomp(model.W1.2, c(0.5, 0.5), 
       compMatch = c("A101+meso+GST+elevated", "A101+meso+GST+ambient"), type = "absolute", interval = "none", reverse = T)
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/2023/Mesotrione_Absolute ED_Multiple Comparisons/MIs_Meso Everything_GC_ DR Percent Bio.tiff",
...
points(x = c(ED50.A82.meso.elevated [1, 1],
             ED50.A82.meso.ambient [1, 1],
             ED50.A101.meso.elevated [1, 1],
             ED50.A101.meso.ambient [1, 1],
             ED50.A101.meso.P450.elevated [1, 1],
             ED50.A101.meso.P450.ambient [1, 1],
             ED50.A101.meso.GST.elevated [1, 1],
             ED50.A101.meso.GST.ambient [1, 1]),
