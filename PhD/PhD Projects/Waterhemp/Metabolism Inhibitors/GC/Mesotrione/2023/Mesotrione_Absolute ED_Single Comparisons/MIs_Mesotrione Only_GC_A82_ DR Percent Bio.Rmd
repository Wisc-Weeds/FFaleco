...
summary.A82.meso <- summaryBy(cbind(percent_bio) ~ pop + rate + temp + herb, data = subset(data.A82.meso),
          FUN=fun)
...
model.LL4 <- drm(percent_bio ~ rate, temp, fct = LL.4(), data = data.A82.meso, type = "continuous")
...
model.W1.2 <- drm(percent_bio ~ rate, temp, fct = W1.2(), data = data.A82.meso, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/2023/Mesotrione_Absolute ED/MIs_Mesotrione Only_GC_A82_ DR Percent Bio.tiff",
