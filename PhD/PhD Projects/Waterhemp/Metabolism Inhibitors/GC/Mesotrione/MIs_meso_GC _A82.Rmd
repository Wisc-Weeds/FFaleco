...
model.LL4<- drm(biomass ~ rate, temp, fct = LL.4(), data = data_A82_meso, type = "continuous")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GC/Mesotrione/GC_Meso Only_A82_DR biomass.tiff.tiff",
...
text(x = 330, y = 3.0, 
     labels = expression("Elevated Upper Limit = 5.7 ("%+-% "0.2)" ^A),
     cex = 1.0,
     col = "black",
     font = 2)
...
text(x = 320, y = 2.7, 
     labels = expression("Ambient Upper Limit = 3.6 ("%+-% "0.2)" ^B),
     cex = 1.0,
     col = "black",
     font = 2)
...
model.LL4<- drm(biomass ~ rate, temp, fct = LL.4(), data = data_A82_meso_P450, type = "continuous")
