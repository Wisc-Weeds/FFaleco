...
data <- read.csv("Data Sheet_Meso_GH_2.csv")
...
model.LL4_biored<- drm(bio_red ~ rate, pop, fct = LL.4(), data = data_meso, type = "continuous")


                
modelFit(model.LL4) # higher the p-value, better.

modelFit(model.LL4_biored)



summary(model.LL4) 

summary(model.LL4_biored) 
...
mselect(model.LL4_biored,  list(L.3(), L.4(), L.5(), LL.2(), LL.3(), LL.5(), W1.3(), W1.4(), W2.4(), baro5()), linreg = T) 
...
model.LL3_biored<- drm(bio_red ~ rate, pop, fct = LL.3(),  data = data_meso, type = "continuous")


modelFit(model.LL3)

modelFit(model.LL3_biored)


summary(model.LL3) # NO parameter c (lower limit). It means lower limit was set to zero.

summary(model.LL3_biored)
...
ED(model.LL3_biored, c(50, 90), type = "relative")
...
compParm(model.LL3_biored, strVal = "e", operator = "-")
...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/PhD Projects/Waterhemp/Metabolism Inhibitors/GH - Copy/Mesotrione/Meso_DR_biomass.tiff",
