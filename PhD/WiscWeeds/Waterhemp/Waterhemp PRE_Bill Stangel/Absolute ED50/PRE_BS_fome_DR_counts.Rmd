...
tiff(file="C:/Users/felip/OneDrive - UW-Madison/Documents/GitHub/FFaleco/PhD/WiscWeeds/Waterhemp/Waterhemp PRE_Bill Stangel/Absolute ED50/Fome_DR_counts.tiff",
...
#text(x = 750, y = 7.0, 
     #labels = expression(paste("ED"[50] ~ "A92 = 132.0 ("%+-% "37.3)"^A)),
     #cex = 1.3,
     #col = "black",
     #font = 2)
...
#text(x = 720, y = 6.2, 
     #labels = expression(paste("ED"[50] ~ "A66 = 13.5 ("%+-% "24.6)"^B)),
     #cex = 1.3,
     #col = "black",
     #font = 2)
