---
title: "Waterhemp PRE BS Fomesafen DR Counts"
...
summary.BS <- summaryBy(cbind(count, biomass) ~ rate + pop, data = subset(data, pop=="BS"),
          FUN=fun)
...
modelFit(model.W1.3) # higher the p-value, better.
...
mselect(model.W1.3,  list(L.3(), L.4(), L.5(), LL.2(), LL.3(), LL.4(), LL.5(), W1.3(), W1.4(), W2.4(), baro5()), linreg = T) 
...
EDcomp(model.W1.3, c(50, 50), type = "relative", interval = "none", reverse = TRUE)

EDcomp(model.W1.3, c(90, 90), type = "relative", interval = "none", reverse = TRUE)
...
text(x = 650, y = 6.0, 
     labels = expression(paste("ED"[50] ~ "BS = 148.9 ("%+-% "38.3)")),
     cex = 1.3,
     col = "black",
     font = 2)
...
text(x = 645, y = 5.2, 
     labels = expression(paste("ED"[50] ~ "A66 = 16.4 ("%+-% "31.8)")),
     cex = 1.3,
     col = "black",
     font = 2)
