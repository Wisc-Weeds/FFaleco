---
title: "BETA BIOMASS REDUCTION - WATERHEMP ALL POST 3X"
...
plot(emm_herb, adjust = "tukey", comparisons = TRUE) + 
  geom_point(size = -1) +
  geom_text(aes(label = c("a", "a", "a", "a", "a", "b", "c", "a")), vjust = -1) +
  ...
  ggsave("All POST 3x_BETA Tukey HSD.jpeg", units="in", width=8, height=5, dpi=600)
