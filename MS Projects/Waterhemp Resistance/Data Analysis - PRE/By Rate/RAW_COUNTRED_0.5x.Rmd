---
title: "RAW COUNT REDUCTION - WATERHEMP ALL PRE 0.5X"
...
ggplot(summary, aes(x = count_red*100, y = reorder(herb, count_red))) + xlim(60, 100) +
  geom_point(size = 2) + 
  ...
  ggsave("All PRE 0.5x_RAW COUNTRED.jpeg", units="in", width=8, height=5, dpi=600)
