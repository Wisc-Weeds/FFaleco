---
title: "RAW BETA COUNT REDUCTION - WATERHEMP ALL PRE 0.5X"
...
plot_RAW + geom_text(aes(label = c("c", "b", "a", "ab", "a")), vjust = -1) +
  ggsave("All PRE 0.5x_RAW.BETA Tukey HSD.jpeg", units="in", width=8, height=5, dpi=600)
