...
ima_ranger <- rand_forest(trees = 1000, mtry = 1, min_n = 245, mode = "classification") %>%
...
gly_ranger <- rand_forest(trees = 1000, mtry = 3, min_n = 10, mode = "classification") %>%
  set_engine("ranger", importance ="impurity") %>%
...
atra_ranger <- rand_forest(trees = 1000, mtry = 2, min_n = 10, mode = "classification") %>%
  set_engine("ranger", importance ="impurity") %>%
