---
title: "BETA BIOMASS REDUCTION - WATERHEMP ALL POST 1X"
...
plot(emm_herb, adjust = "tukey", comparisons = TRUE) + 
  geom_point(size = -1) +
  geom_text(aes(label = c("cd", "bc", "d", "ab", "a", "e", "f", "ab")), vjust = -1) +
  ...
  ggsave("All POST 1x_BETA Tukey HSD.jpeg", units="in", width=8, height=5, dpi=600)
