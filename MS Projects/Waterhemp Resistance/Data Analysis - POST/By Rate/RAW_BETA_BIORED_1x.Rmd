---
title: "RAW.BETA BIOMASS REDUCTION - WATERHEMP ALL POST 1X"
...
plot_RAW + geom_text(aes(label = c("cd", "bc", "d", "ab", "a", "e", "f", "ab")), vjust = -1) +
  ggsave("All POST 1x_RAW.BETA Tukey HSD.jpeg", units="in", width=8, height=5, dpi=600)
