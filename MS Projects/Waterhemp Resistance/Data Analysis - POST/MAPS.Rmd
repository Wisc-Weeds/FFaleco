...
base + 
  ...
  scale_color_manual(name = "Herbicide Resistance 1x Dose POST", values = c("darkgreen", "blue", "black", "orange2","cyan4", "darkorchid3", "red", "firebrick" )) +
  theme_map() +
  ...
  ggsave("MAP_POPMAINPOOL_1X.jpeg", units = "in", width = 13, height = 11, dpi = 600)
