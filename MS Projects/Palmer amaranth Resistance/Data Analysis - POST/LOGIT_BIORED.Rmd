...
plot(emm_pop_herb_Dose, adjust = "tukey", comparisons = F, alpha = 0.05) + 
  ...
  ggsave("LOGIT Tukey HSD_POPxHERBxDOSE.tiff", units="in", width=30, height=7, dpi=1000, compression = "lzw")
  
  
#ggsave("[Faleco]Fig3.tiff", units="in", width=30, height=7, dpi=1000, compression = "lzw")
